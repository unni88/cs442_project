...
public class MyDB extends SQLiteOpenHelper {
    ...
    /*private static final String DATABASE_CREATE = "create table " + TABLE_NAME + "(" + COLUMN_ID
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + COLUMN_ITEM_NAME + " TEXT NOT NULL , " + COLUMN_ITEM_PRICE
            + " TEXT NOT NULL, " + COLUMN_ITEM_DESC + " TEXT NULL," + COLUMN_ITEM_ING + " TEXT NULL," + COLUMN_ITEM_RECIPIE + " TEXT NULL);";
*/
    //private static final String DATABASE_CREATE1 = "create table fooditem(_id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL ,price TEXT NOT NULL);";
